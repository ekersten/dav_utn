		...
		<section class="tpl-2-col profesores">
			...
			<div class="row contenedor">
				<div class="column medium-9 pricipal">
					...
					<p>Es un programa que se propone brindar la capacidad de desarrollar material educativo multimedia de características interactivas para poder ser utilizado a través de soportes off line u on line, soportado en base a software libre.</p>
					<p>Actualmente PPF está compuesto por tres cursos: CMEM Cs. Básicas, CMEM Genérico y EDM E-learning Docentes. Los contenidos de los diferentes módulos de cada uno de los cursos, fueron confeccionados por docentes universitarios especialistas en los temas. Todos los programas están destinados a Docentes y Profesores de nivel Medio y Universitario.</p>
					...
					<p>Cada curso virtual tiene un espacio de trabajo dentro de la plataforma virtual, con sus respectivos contenidos digitales en diferentes formatos, divididos en módulos y con un grupo de tutores que guían y orientan los aprendizajes.</p>
