...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <section class="tpl-2-col digital-junior">
            ...
            <div class="subnav" data-activa="capacitacion">
            ...
            <div class="row contenedor">
                <div class="column medium-9 principal">
                    ...
                    <p>Los colegios que forman parte de nuestra comunidad a través del Programa Digital Junior, pueden participar de todas las capacitaciones propuestas a continuación en forma totalmente gratuita.</p>
                    <p>Para consultas sobre las capacitaciones docentes envíenos un mail a <a href="mailto:info@dav.sceu.utn.edu.ar">info@dav.sceu.utn.edu.ar</a></p>
