...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		...
		<section class="tpl-2-col entropia">
			...
			<div class="row contenedor">
				<div class="column medium-9 principal">
					...
					<p>A su vez, durante este trayecto, los alumnos son acompañados por estudiantes avanzados de la UTN.BA, quienes participan del programa cumpliendo la función de tutores y realizando apoyo y seguimiento a los alumnos, y que a su vez son supervisados por docentes graduados de la Universidad, con el objetivo de mejorar su rendimiento académico y asegurar la continuidad en todas las instancias del programa. </p>
