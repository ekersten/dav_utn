		...
		<section class="tpl-2-col kimtech">
			...
			<div class="row contenedor">
				<div class="column medium-9 principal">
					...
					<p>KIMTECH ha sido pensado para que las escuelas logren abordar el trabajo con robótica superando el obstáculo que impone la adquisición de equipamiento tecnológico y otras limitaciones, como ser tiempo, espacio y la formación de especialistas.</p>
					
				</div>
				<div class="column medium-3 secundario">
					<div class="video">
                        <a href="https://www.youtube.com/watch?v=Y5P8q-_GKgE" class="fancybox-media"><img src="img/video_kimtech.jpg" alt=""> </a>
                    </div>
					<p><em>Kimtech</em> permite integrar conocimientos de distintas asignaturas, aplicándolos a situaciones reales. Estimulando la capacidad creativa y desarrollando un pensamiento ordenado, tendiente a la búsqueda de soluciones.</p>
				</div>
			</div>
		</section>
